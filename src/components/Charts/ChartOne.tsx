        ...
        <div className="flex w-full flex-wrap gap-3 sm:gap-5">
          <div className="flex min-w-47.5">
            ...
            <div className="w-full">
              <p className="font-semibold text-primary">전체 작업</p>
              <p className="text-sm font-medium">2024.11.01 - 2024.11.30</p>
            </div>
          </div>
          <div className="flex min-w-47.5">
            ...
            <div className="w-full">
              <p className="font-semibold text-secondary">완료된 작업</p>
              <p className="text-sm font-medium">2024.11.01 - 2024.11.30</p>
            </div>
          </div>
        </div>
